...
c1 = ROOT.TCanvas('c1','c1 cap_d1')
c2 = ROOT.TCanvas('c2','c2 cap_d1')
c3 = ROOT.TCanvas('c3','c3 cap_d1')
c4 = ROOT.TCanvas('c4','c4 cap_d1')
c5 = ROOT.TCanvas('c5','c5 cap_d1')
...
#slimmed mu
tt.Draw("l0_pt >> smul0", "abs(l0_pdgId)==13 & l0_matched_muon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 2.4 & abs(l0_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l1_pt >> smunfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 0 & l1_pt > 5 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l2_pt >> smunfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 0 & l2_pt > 5 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l1_pt >> smucfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 0 & l1_pt > 5 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l2_pt >> smucfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 0 & l2_pt > 5 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp < 4")
#ds mu 
tt.Draw("l0_pt >> dsmul0", "abs(l0_pdgId)==13 & l0_matched_dsmuon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 2.4 & abs(l0_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l1_pt >> dsmunfl1", "abs(l1_pdgId) == 13 & l1_matched_dsmuon_charge == l1_charge & l1_matched_dsmuon_pt > 0 & l1_pt > 5 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l2_pt >> dsmunfl2", "abs(l2_pdgId) == 13 & l2_matched_dsmuon_charge == l2_charge & l2_matched_dsmuon_pt > 0 & l2_pt > 5 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l1_pt >> dsmucfl1", "abs(l1_pdgId) == 13 & l1_matched_dsmuon_charge != l1_charge & l1_matched_dsmuon_pt > 0 & l1_pt > 5 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp < 4")
tt.Draw("l2_pt >> dsmucfl2", "abs(l2_pdgId) == 13 & l2_matched_dsmuon_charge != l2_charge & l2_matched_dsmuon_pt > 0 & l2_pt > 5 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp < 4")
...
c1.SaveAs(output_dir + 'cap_d1_smu_l12.root')
c2.SaveAs(output_dir + 'cap_d1_dsmu_l12.root')
c3.SaveAs(output_dir + 'cap_d1_smu_l012pt.root')
c4.SaveAs(output_dir + 'cap_d1_dsmu_l012pt.root')
c5.SaveAs(output_dir + 'cap_d1.root')
