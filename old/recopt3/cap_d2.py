...
#slimmed mu
tt.Draw("l1_pt >> smunfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 3 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
tt.Draw("l2_pt >> smunfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 3 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
tt.Draw("l1_pt >> smucfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 3 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
tt.Draw("l2_pt >> smucfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 3 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
#ds mu 
tt.Draw("l1_pt >> dsmunfl1", "abs(l1_pdgId) == 13 & l1_matched_dsmuon_charge == l1_charge & l1_matched_dsmuon_pt > 3 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
tt.Draw("l2_pt >> dsmunfl2", "abs(l2_pdgId) == 13 & l2_matched_dsmuon_charge == l2_charge & l2_matched_dsmuon_pt > 3 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
tt.Draw("l1_pt >> dsmucfl1", "abs(l1_pdgId) == 13 & l1_matched_dsmuon_charge != l1_charge & l1_matched_dsmuon_pt > 3 & abs(l1_eta) < 2.4 & abs(l1_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
tt.Draw("l2_pt >> dsmucfl2", "abs(l2_pdgId) == 13 & l2_matched_dsmuon_charge != l2_charge & l2_matched_dsmuon_pt > 3 & abs(l2_eta) < 2.4 & abs(l2_eta) > 1.2 & hnl_2d_disp > 4 & hnl_2d_disp < 120")
