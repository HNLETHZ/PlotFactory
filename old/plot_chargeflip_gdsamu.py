...
#d
print('Filling d') 
#tt.Draw("l0_pt >> dnfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge == l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4")
tt.Draw("l1_pt >> dnfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge == l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4")
tt.Draw("l2_pt >> dnfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge == l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4")
#tt.Draw("l0_pt >> dcfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge != l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4")
tt.Draw("l1_pt >> dcfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge != l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4")
tt.Draw("l2_pt >> dcfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge != l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4")
##d1
print('Filling d1') 
#tt.Draw("l0_pt >> d1nfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge == l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4 & hnl_2d_disp < 10")
tt.Draw("l1_pt >> d1nfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge == l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4 & hnl_2d_disp < 10")
tt.Draw("l2_pt >> d1nfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge == l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4 & hnl_2d_disp < 10")
#tt.Draw("l0_pt >> d1cfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge != l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4 & hnl_2d_disp < 10")
tt.Draw("l1_pt >> d1cfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge != l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4 & hnl_2d_disp < 10")
tt.Draw("l2_pt >> d1cfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge != l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4 & hnl_2d_disp < 10")
##d2 
print('Filling d2') 
#tt.Draw("l0_pt >> d2nfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge == l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4 & hnl_2d_disp < 100 & hnl_2d_disp > 10")
tt.Draw("l1_pt >> d2nfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge == l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4 & hnl_2d_disp < 100 & hnl_2d_disp > 10")
tt.Draw("l2_pt >> d2nfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge == l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4 & hnl_2d_disp < 100 & hnl_2d_disp > 10")
#tt.Draw("l0_pt >> d2cfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge != l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4 & hnl_2d_disp < 100 & hnl_2d_disp > 10")
tt.Draw("l1_pt >> d2cfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge != l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4 & hnl_2d_disp < 100 & hnl_2d_disp > 10")
tt.Draw("l2_pt >> d2cfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge != l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4 & hnl_2d_disp < 100 & hnl_2d_disp > 10")
##d3
print('Filling d3') 
#tt.Draw("l0_pt >> d3nfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge == l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4 & hnl_2d_disp < 600 & hnl_2d_disp > 100")
tt.Draw("l1_pt >> d3nfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge == l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4 & hnl_2d_disp < 600 & hnl_2d_disp > 100")
tt.Draw("l2_pt >> d3nfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge == l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4 & hnl_2d_disp < 600 & hnl_2d_disp > 100")
#tt.Draw("l0_pt >> d3cfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge != l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4 & hnl_2d_disp < 600 & hnl_2d_disp > 100")
tt.Draw("l1_pt >> d3cfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge != l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4 & hnl_2d_disp < 600 & hnl_2d_disp > 100")
tt.Draw("l2_pt >> d3cfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge != l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4 & hnl_2d_disp < 600 & hnl_2d_disp > 100")

# Filling TH2
#tt.Draw("l0_pt:l0_matched_dgmuon_dxy>>nfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge == l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4")
#tt.Draw("l1_pt:l1_matched_dgmuon_dxy>>nfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge == l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4")
#tt.Draw("l2_pt:l2_matched_dgmuon_dxy>>nfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge == l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4")
#tt.Draw("l0_pt:l0_matched_dgmuon_dxy>>cfl0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_charge != l0_charge & l0_matched_dgmuon_pt > 3 & abs(l0_eta) < 2.4")
#tt.Draw("l1_pt:l1_matched_dgmuon_dxy>>cfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge != l1_charge & l1_matched_dgmuon_pt > 3 & abs(l1_eta) < 2.4")
#tt.Draw("l2_pt:l2_matched_dgmuon_dxy>>cfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge != l2_charge & l2_matched_dgmuon_pt > 3 & abs(l2_eta) < 2.4")
