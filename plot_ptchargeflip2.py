...
tt.Draw('l1_pt >> h_smu_l1_cf','l1_pt>5 & abs(l1_eta)<2.4 & abs(l1_pdgId)==13 & l1_matched_muon_pt>0 & l1_charge != l1_matched_muon_charge')
tt.Draw('l2_pt >> h_smu_l2_cf','l2_pt>5 & abs(l2_eta)<2.4 & abs(l2_pdgId)==13 & l2_matched_muon_pt>0 & l2_charge != l2_matched_muon_charge')
tt.Draw('l1_pt >> h_smu_l1_nf','l1_pt>5 & abs(l1_eta)<2.4 & abs(l1_pdgId)==13 & l1_matched_muon_pt>0 & l1_charge == l1_matched_muon_charge')
tt.Draw('l2_pt >> h_smu_l2_nf','l2_pt>5 & abs(l2_eta)<2.4 & abs(l2_pdgId)==13 & l2_matched_muon_pt>0 & l2_charge == l2_matched_muon_charge')

tt.Draw('l1_pt >> h_dsmu_l1_cf','l1_pt>5 & abs(l1_eta)<2.4 & abs(l1_pdgId)==13 & l1_matched_dsmuon_pt>0 & l1_charge != l1_matched_dsmuon_charge')
tt.Draw('l2_pt >> h_dsmu_l2_cf','l2_pt>5 & abs(l2_eta)<2.4 & abs(l2_pdgId)==13 & l2_matched_dsmuon_pt>0 & l2_charge != l2_matched_dsmuon_charge')
tt.Draw('l1_pt >> h_dsmu_l1_nf','l1_pt>5 & abs(l1_eta)<2.4 & abs(l1_pdgId)==13 & l1_matched_dsmuon_pt>0 & l1_charge == l1_matched_dsmuon_charge')
tt.Draw('l2_pt >> h_dsmu_l2_nf','l2_pt>5 & abs(l2_eta)<2.4 & abs(l2_pdgId)==13 & l2_matched_dsmuon_pt>0 & l2_charge == l2_matched_dsmuon_charge')
