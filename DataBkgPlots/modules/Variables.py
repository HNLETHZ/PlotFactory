...
essential_vars = [
            ...
            # VCfg(name='hnl_m_12_wide' , drawname='hnl_m_12', binning={'nbinsx':20, 'xmin':0   , 'xmax':200  }, unit='GeV', xtitle='dimuon mass'),
            # VCfg(name='hnl_m_12_low' , drawname='hnl_m_12', binning={'nbinsx':44, 'xmin':0   , 'xmax':22.  }, unit='GeV', xtitle='dimuon mass'),
            # VCfg(name='hnl_m_12_money' , drawname='hnl_m_12', binning={'nbinsx':22, 'xmin':0   , 'xmax':11.  }, unit='GeV', xtitle='dimuon mass'),
