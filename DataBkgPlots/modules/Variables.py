...
essential_vars = [
            VCfg(name='_norm_'     , drawname='norm_count', binning={'nbinsx':5, 'xmin':-1.5, 'xmax':3.5}, unit='', xtitle='Normalisation'),
            VCfg(name='hnl_m_12_wide', drawname='hnl_m_12', binning={'nbinsx':40, 'xmin':0   , 'xmax':200 }, unit='GeV', xtitle='dimuon mass'),
            VCfg(name='hnl_m_12_low' , drawname='hnl_m_12', binning={'nbinsx':10, 'xmin':0   , 'xmax':10  }, unit='GeV', xtitle='dimuon mass'),
            ...
            VCfg(name='hnl_dr_12'        , binning={'nbinsx':60, 'xmin':0   , 'xmax':6 }, unit=None, xtitle='#DeltaR (#mu_{1}, #mu_{2})'),
