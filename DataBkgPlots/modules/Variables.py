...
essential_vars = [
            VCfg(name='_norm_'     , drawname='norm_count', binning={'nbinsx':5, 'xmin':-1.5, 'xmax':3.5}, unit='', xtitle='Normalisation'),
	    # VCfg(name='hnl_m_12_wide' , drawname='hnl_m_12', binning={'nbinsx':200, 'xmin':0   , 'xmax':200  }, unit='GeV', xtitle='dimuon mass'),
	    ...
	    # VCfg(name='hnl_m_12_micro' , drawname='hnl_m_12', binning={'nbinsx':20, 'xmin':0   , 'xmax':2.  }, unit='GeV', xtitle='dimuon mass'),
	    ...
	    # VCfg(name='hnl_m_02_zoom', drawname = 'hnl_m_02', binning={'nbinsx':20, 'xmin':0.   , 'xmax':10. }, unit='GeV', xtitle='mass(l_{0},#mu_{1})'),
            ...
            # VCfg(name='hnl_dr_12_zoom', drawname='hnl_dr_12', binning={'nbinsx':20, 'xmin':0.11  , 'xmax':0.12 }, unit=None, xtitle='#DeltaR (#mu_{1}, #mu_{2})'),
            ...
            # VCfg(name='l2_ptCone', drawname='l2_pt_cone',      binning={'nbinsx':20, 'xmin':0, 'xmax':80},    unit='GeV', xtitle='l2 p^{Cone}_{T}'),
            # VCfg(name='l1_ptCone', drawname='l2_pt_cone',      binning={'nbinsx':20, 'xmin':0, 'xmax':80},    unit='GeV', xtitle='l2 p^{Cone}_{T}'),
