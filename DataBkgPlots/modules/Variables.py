...
test_vars = [
            VCfg(name='hnl_m_12_low' , drawname='hnl_m_12', binning={'nbinsx':40, 'xmin':0   , 'xmax':4.  }, unit='GeV', xtitle='dimuon mass'),
            VCfg(name='hnl_dr_12'        , binning={'nbinsx':40, 'xmin':0   , 'xmax':0.8 }, unit=None, xtitle='#DeltaR (#mu_{1}, #mu_{2})'),
            VCfg(name='m_triL_wide', drawname='hnl_w_vis_m',       binning={'nbinsx':40, 'xmin':0., 'xmax':250}, unit='GeV', xtitle='Tri-Lepton Mass'),
            VCfg(name='hnl_2d_disp', binning={'nbinsx':40, 'xmin':0   , 'xmax':2. }, unit='cm' , xtitle='2D displacement'),
            # VCfg(name='hnl_dphi_hnvis0_wide'  ,drawname='abs_dphi_hnvis0', binning={'nbinsx':40, 'xmin': 0, 'xmax':pi}, unit=None, xtitle='|#Delta#phi (dimuon, l_{0})|'),
            # VCfg(name='hnl_m_12_wide', drawname='hnl_m_12', binning={'nbinsx':80, 'xmin':0   , 'xmax':200 }, unit='GeV', xtitle='dimuon mass'),
            # VCfg(name='hnl_m_12_low' , drawname='hnl_m_12', binning={'nbinsx':40, 'xmin':0   , 'xmax':10  }, unit='GeV', xtitle='dimuon mass'),
            # VCfg(name='_norm_'     , drawname='norm_count', binning={'nbinsx':5, 'xmin':-1.5, 'xmax':3.5}, unit='', xtitle='Normalisation'),
...
essential_vars = [
            VCfg(name='_norm_'     , drawname='norm_count', binning={'nbinsx':5, 'xmin':-1.5, 'xmax':3.5}, unit='', xtitle='Normalisation'),
            VCfg(name='hnl_m_12_wide' , drawname='hnl_m_12', binning={'nbinsx':40, 'xmin':0   , 'xmax':120  }, unit='GeV', xtitle='dimuon mass'),
            VCfg(name='hnl_m_12_low' , drawname='hnl_m_12', binning={'nbinsx':22, 'xmin':0   , 'xmax':22.  }, unit='GeV', xtitle='dimuon mass'),
            VCfg(name='hnl_m_12_money' , drawname='hnl_m_12', binning={'nbinsx':11, 'xmin':0   , 'xmax':11.  }, unit='GeV', xtitle='dimuon mass'),
            VCfg(name='hnl_2d_disp', binning={'nbinsx':10, 'xmin':0   , 'xmax':2. }, unit='cm' , xtitle='2D displacement'),
            VCfg(name='hnl_2d_disp_low',drawname='hnl_2d_disp', binning={'nbinsx':20, 'xmin':0   , 'xmax':0.02 }, unit='cm' , xtitle='2D displacement'),
            VCfg(name='hnl_2d_disp_wide',drawname='hnl_2d_disp', binning={'nbinsx':20, 'xmin':0   , 'xmax':20 }, unit='cm' , xtitle='2D displacement'),
            ...
            VCfg(name='m_triL_wide', drawname='hnl_w_vis_m',       binning={'nbinsx':40, 'xmin':0., 'xmax':200}, unit='GeV', xtitle='Tri-Lepton Mass'),
            VCfg(name='nbj', binning={'nbinsx':12, 'xmin':-0.5, 'xmax':11.5}, unit=None, xtitle='N_{b-jets}'),
            VCfg(name='ptCone', drawname='pt_cone',      binning={'nbinsx':20, 'xmin':0, 'xmax':70},    unit='GeV', xtitle='p^{Cone}_{T}'),
            VCfg(name='l1_pt'      , binning={'nbinsx':20, 'xmin':0.  , 'xmax':50.}, unit='GeV', xtitle='l1 p_{T}'),
            VCfg(name='l2_pt'      , binning={'nbinsx':20, 'xmin':0.  , 'xmax':50.}, unit='GeV', xtitle='l2 p_{T}'),
            VCfg(name='l1_dxy'      , binning={'nbinsx':40, 'xmin':-0.02  , 'xmax':.02}, unit='cm', xtitle='l1_dxy'),
            VCfg(name='l2_dxy'      , binning={'nbinsx':40, 'xmin':-0.02  , 'xmax':.02}, unit='cm', xtitle='l2_dxy'),
            VCfg(name='n_vtx', binning={'nbinsx':30, 'xmin':0, 'xmax':60}, unit=None, xtitle='N_{vertices}'),
            VCfg(name='pfmet_pt'         , binning={'nbinsx':40, 'xmin':0., 'xmax':300.}, unit='GeV', xtitle='E_{T}^{miss} (PF)'),
            VCfg(name='sv_prob'          , binning={'nbinsx':40 , 'xmin':0   , 'xmax':1   }, unit=None, xtitle='SV probability'),
            VCfg(name='l1_reliso_rho_03', binning={'nbinsx':20, 'xmin':0., 'xmax':0.5}, unit=None, xtitle='1st muon relative isolation cone 0.3'),
            VCfg(name='l2_reliso_rho_03', binning={'nbinsx':20, 'xmin':0., 'xmax':0.5}, unit=None, xtitle='2nd muon relative isolation cone 0.3'),
            VCfg(name='hnl_dphi_hnvis0_wide'  ,drawname='abs_dphi_hnvis0', binning={'nbinsx':40, 'xmin': 0, 'xmax':pi+0.3}, unit=None, xtitle='|#Delta#phi (dimuon, l_{0})|'),
            VCfg(name='hnl_dphi_12'  ,drawname='abs_dphi_12', binning={'nbinsx':40, 'xmin': 0, 'xmax':pi+0.3}, unit=None, xtitle='|#Delta#phi (l_{1}, l_{2})|'),
            ...
            VCfg(name='l0_phi'      , drawname='l1_phi',binning={'nbinsx':40, 'xmin':-pi  , 'xmax':pi}, unit='GeV', xtitle='l0 #phi'),
            ...
            VCfg(name='hnl_hn_vis_phi', drawname='hnl_hn_vis_phi', binning={'nbinsx':40, 'xmin':-pi, 'xmax':pi }, unit=None , xtitle='dimuon #phi'),
            VCfg(name='hnl_2d_disp_sig', drawname='hnl_2d_disp_sig', binning={'nbinsx':40, 'xmin':0., 'xmax':5. }, unit=None , xtitle='hnl_2d_disp_sig'),
	    ...
	    # VCfg(name='hnl_m_12_cone_wide' , drawname='hnl_m_12_ConeCorrected2', binning={'nbinsx':120, 'xmin':0   , 'xmax':120  }, unit='GeV', xtitle='dimuon mass (cone corrected)'),
	    # VCfg(name='hnl_m_12_cone_low' , drawname='hnl_m_12_ConeCorrected2', binning={'nbinsx':22, 'xmin':0   , 'xmax':22.  }, unit='GeV', xtitle='dimuon mass (cone corrected)'),
	    # VCfg(name='hnl_m_12_cone_money' , drawname='hnl_m_12_ConeCorrected2', binning={'nbinsx':11, 'xmin':0   , 'xmax':11.  }, unit='GeV', xtitle='dimuon mass (cone corrected)'),
	    ...
	    # VCfg(name='sv_prob_zoom', drawname = 'sv_prob', binning={'bins': np.logspace(-12,0,50)}, unit=None, xtitle='SV probability'),
            # VCfg(name='hnl_m_12_zoom' , drawname='hnl_m_12', binning={'nbinsx':15, 'xmin':1   , 'xmax':4.  }, unit='GeV', xtitle='dimuon mass'),
	    ...
	    # VCfg(name='l2_ptCone', drawname='l2_ptcone',      binning={'nbinsx':20, 'xmin':0, 'xmax':50},    unit='GeV', xtitle='l2 p^{Cone}_{T}'),
            ...
            # VCfg(name='abs_hnl_hn_vis_eta', drawname='abs_hnl_hn_vis_eta', binning={'nbinsx':20, 'xmin':0., 'xmax':2.5 }, unit=None , xtitle='dimuon #eta'),
            ...
            # VCfg(name='hnl_m_12_corrected_test' , drawname='hnl_m_12_ConeCorrected_test', binning={'nbinsx':20, 'xmin':0   , 'xmax':10  }, unit='GeV', xtitle='dimuon mass'),
