...
essential_vars = [
	    ...
	    # VCfg(name='hnl_m_12_money' , drawname='hnl_m_12', binning={'nbinsx':6, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            ...
            # VCfg(name='m_triL_wide', drawname='hnl_w_vis_m',       binning={'nbinsx':20, 'xmin':0., 'xmax':200}, unit='GeV', xtitle='Tri-Lepton Mass (GeV)'),
            ...
            # VCfg(name='hnl_dr_12_low', drawname='hnl_dr_12', binning={'nbinsx':10, 'xmin':0   , 'xmax':1.0 }, unit=None, xtitle='#DeltaR (#mu_{1}, #mu_{2})'),
            ...
            # VCfg(name='l2_dxy'      , binning={'nbinsx':10, 'xmin':-0.02  , 'xmax':.02}, unit='cm', xtitle='l2_dxy (GeV)'),
            # VCfg(name='l2_dxy'      , binning={'nbinsx':10, 'xmin':-0.  , 'xmax':.2}, unit='cm', xtitle='l2_dxy (GeV)'),
            # VCfg(name='n_vtx', binning={'nbinsx':30, 'xmin':0, 'xmax':60}, unit=None, xtitle='N_{vertices}'),
            # VCfg(name='sv_cos', drawname='sv_cos',       binning={'nbinsx':20, 'xmin':0., 'xmax':1.}, unit='GeV', xtitle='Tri-Lepton Mass (GeV)'),
            ...
            # VCfg(name='hnl_m_12_money_disp1_0p5_fine' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            ...
            # VCfg(name='hnl_m_12_money_disp2_0p5_5' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp3_5' , drawname='hnl_m_12', binning={'nbinsx':2, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
	    ...
	    VCfg(name='hnl_m_12_money_disp3_5' , drawname='hnl_m_12', binning={'nbinsx':2, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            ...
            # VCfg(name='Martina_hnl_m_12_money_disp1_2p0' , drawname='hnl_m_12', binning={'nbinsx':20, 'xmin':0   , 'xmax':20.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='Martina_hnl_m_12_money_disp2_2p0_10' , drawname='hnl_m_12', binning={'nbinsx':20, 'xmin':0   , 'xmax':20.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='Martina_hnl_m_12_money_disp3_10' , drawname='hnl_m_12', binning={'nbinsx':20, 'xmin':0   , 'xmax':20.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='Martina_hnl_m_12_money_betterbinning' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='Martina_hnl_m_12_money_disp1_2p0_betterbinning' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='Martina_hnl_m_12_money_disp2_2p0_10_betterbinning' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='Martina_hnl_m_12_money_disp3_10_betterbinning' , drawname='hnl_m_12', binning={'nbinsx':2, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='Martina_hnl_2d_disp',drawname='hnl_2d_disp', binning={'nbinsx':32, 'xmin':0   , 'xmax':8 }, unit='cm' , xtitle='2D displacement (cm)'),
            # VCfg(name='Martina_hnl_dr_12', drawname='hnl_dr_12', binning={'nbinsx':40, 'xmin':0   , 'xmax':4. }, unit=None, xtitle='#DeltaR (#mu_{1}, #mu_{2})'),
            # VCfg(name='Martina__triL_wide', drawname='hnl_w_vis_m',       binning={'nbinsx':40, 'xmin':20., 'xmax':300}, unit='GeV', xtitle='Tri-Lepton Mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp1_2p0' , drawname='hnl_m_12', binning={'nbinsx':6, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp2_2p0_10' , drawname='hnl_m_12', binning={'nbinsx':6, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp3_10' , drawname='hnl_m_12', binning={'nbinsx':2, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
	    # # VCfg(name='Martina__triL_wide', drawname='hnl_w_vis_m',       binning={'nbinsx':40, 'xmin':0., 'xmax':200}, unit='GeV', xtitle='Tri-Lepton Mass (GeV)'),
	    # VCfg(name='Martina_l2_dxy',drawname='l2_dxy'      , binning={'nbinsx':25, 'xmin':0.  , 'xmax':1.0}, unit='cm', xtitle='l2_dxy (GeV)'),
	    # VCfg(name='l2_dxy'      , binning={'nbinsx':10, 'xmin':-0.  , 'xmax':.2}, unit='cm', xtitle='l2_dxy (GeV)'),
