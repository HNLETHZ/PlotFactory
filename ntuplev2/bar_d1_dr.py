...
c1 = ROOT.TCanvas('c1','c1 bar_d1_dr sa')
c2 = ROOT.TCanvas('c2','c2 bar_d1_dr ds')
c3 = ROOT.TCanvas('c3','c3 bar_d1_dr sa')
c4 = ROOT.TCanvas('c4','c4 bar_d1_dr ds')
c5 = ROOT.TCanvas('c5','c5 bar_d1_dr sa / ds')
c6 = ROOT.TCanvas('c6','c6 bar_d1_dr g')
c7 = ROOT.TCanvas('c7','c7 bar_d1_dr dg')
c8 = ROOT.TCanvas('c8','c8 bar_d1_dr g')
c9 = ROOT.TCanvas('c9','c9 bar_d1_dr dg')
c10= ROOT.TCanvas('c10','c10 bar_d1_dr g / dg')
##################### 
# create histograms #
#####################
# d in cm           #
...
# slimmed standalone #
###################### 
tt.Draw("hnl_dr_12 >> samunfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_sa == 1 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> samunfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_sa == 1 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> samucfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_sa == 1 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> samucfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_sa == 1 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
######################## 
# displaced standalone #
######################## 
tt.Draw("hnl_dr_12 >> dsmunfl1", "abs(l1_pdgId) == 13 & l1_matched_dsmuon_charge == l1_charge & l1_matched_dsmuon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> dsmunfl2", "abs(l2_pdgId) == 13 & l2_matched_dsmuon_charge == l2_charge & l2_matched_dsmuon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> dsmucfl1", "abs(l1_pdgId) == 13 & l1_matched_dsmuon_charge != l1_charge & l1_matched_dsmuon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> dsmucfl2", "abs(l2_pdgId) == 13 & l2_matched_dsmuon_charge != l2_charge & l2_matched_dsmuon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
################## 
# slimmed global #
################## 
tt.Draw("hnl_dr_12 >> gmunfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_gl == 1 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> gmunfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_gl == 1 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> gmucfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_gl == 1 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> gmucfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_gl == 1 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
#################### 
# displaced global #
####################
tt.Draw("hnl_dr_12 >> dgmunfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge == l1_charge & l1_matched_dgmuon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> dgmunfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge == l2_charge & l2_matched_dgmuon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> dgmucfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge != l1_charge & l1_matched_dgmuon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
tt.Draw("hnl_dr_12 >> dgmucfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge != l2_charge & l2_matched_dgmuon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 2.4")#0.8 & hnl_2d_disp < 4")
#################### 
# Computing histos #
#################### 
...
for cc in [c1,c2,c3,c4,c5,c6,c7,c8,c9,c10]:
    ...
    cc.Update()
###################################################  
c1.SaveAs(output_dir + 'bar_d1_cf_dr_samu_l12.root')
c2.SaveAs(output_dir + 'bar_d1_cf_dr_dsmu_l12.root')
c3.SaveAs(output_dir + 'bar_d1_dr_samu_l12.root')
c4.SaveAs(output_dir + 'bar_d1_dr_dsmu_l12.root')
c5.SaveAs(output_dir + 'bar_d1_cf_dr_sa.root')
c6.SaveAs(output_dir + 'bar_d1_cf_dr_gmu_l12.root')
c7.SaveAs(output_dir + 'bar_d1_cf_dr_dgmu_l12.root')
c8.SaveAs(output_dir + 'bar_d1_cf_dr_gmu_l12.root')
c9.SaveAs(output_dir + 'bar_d1_dr_dgmu_l12.root')
c10.SaveAs(output_dir + 'bar_d1_cf_dr_gl.root')
################################################### 
