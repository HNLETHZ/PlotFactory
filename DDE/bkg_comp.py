]0;IPython: PlotFactory/DDEPython 2.7.11 (default, Sep 16 2017, 15:17:11) 
...
DYJetsToLL_M50_prompt_m 
cuts:	l1_pt > 20  &&  l2_pt > 10  &&  l0_pt > 27  &&  abs(l0_dz) < 0.2 &&  abs(l1_dz) < 0.2 &&  abs(l2_dz) < 0.2   &&  abs(l0_dxy) < 0.045 &&  abs(l1_dxy) < 0.045 &&  abs(l2_dxy) < 0.045   && l0_id_m && l1_id_m && l2_id_m   && abs(l0_eta) < 2.4 && abs(l1_eta) < 2.4 && abs(l2_eta) < 2.4   && l0_reliso05 < 0.1 && l1_reliso05 < 0.1 && l2_reliso05 < 0.1   && hnl_dr_01 > 0.05 && hnl_dr_02 > 0.05 && hnl_dr_12 > 0.05  
	 entries 		100.0% 	358
	 no_fakes 		16.8% 	60
...
DYJetsToLL_M10to50_prompt_m 
cuts:	l1_pt > 20  &&  l2_pt > 4  &&  l0_pt > 4  &&  abs(l0_dz) < 0.2 &&  abs(l1_dz) < 0.2 &&  abs(l2_dz) < 0.2   &&  abs(l0_dxy) < 0.045 &&  abs(l1_dxy) < 0.045 &&  abs(l2_dxy) < 0.045   && l0_id_m && l1_id_m && l2_id_m   && abs(l0_eta) < 2.4 && abs(l1_eta) < 2.4 && abs(l2_eta) < 2.4   && l0_reliso05 < 0.1 && l1_reliso05 < 0.1 && l2_reliso05 < 0.1   && hnl_dr_01 > 0.05 && hnl_dr_02 > 0.05 && hnl_dr_12 > 0.05  
	 entries 		100.0% 	13
	 no_fakes 		7.7% 	1
