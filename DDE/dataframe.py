...
l1_e_loose += ' && l1_reliso_rho_04 < 1.0'                                                                                            # reliso bound for LOOSE
...
### AND EEM
l0l1_mm  = 'l0_pt > 27 && abs(l0_eta) < 2.5 && l0_id_t == 1 && abs(l0_dz) < 0.2 && abs(l0_dxy) < 0.05 && l0_reliso_rho_04 < 0.2'      # l0 genuine
l0l1_mm += ' && l1_pt > 15 && abs(l1_eta) < 2.5 && l1_id_t == 1 && abs(l1_dz) < 0.2 && abs(l1_dxy) < 0.05 && l1_reliso_rho_04 < 0.2'  # l1 genuine 
l0l1_mm += ' && hnl_q_01 == 0'                                                                                                        # opposite charge
###########################################################################################################################################################################################
