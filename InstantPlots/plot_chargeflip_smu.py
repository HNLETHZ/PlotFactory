...
dstack= ROOT.THStack("dstack","slimmed muons")
...
#d
print('Filling d') 
#tt.Draw("l0_pt >> dnfl0", "abs(l0_pdgId) == 13 & l0_matched_muon_charge == l0_charge & l0_matched_muon_pt > 3 & abs(l0_eta) < 2.4")
tt.Draw("l1_pt >> dnfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 3 & abs(l1_eta) < 2.4")
tt.Draw("l2_pt >> dnfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 3 & abs(l2_eta) < 2.4")
#tt.Draw("l0_pt >> dcfl0", "abs(l0_pdgId) == 13 & l0_matched_muon_charge != l0_charge & l0_matched_muon_pt > 3 & abs(l0_eta) < 2.4")
tt.Draw("l1_pt >> dcfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 3 & abs(l1_eta) < 2.4")
tt.Draw("l2_pt >> dcfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 3 & abs(l2_eta) < 2.4")
##d1
print('Filling d1') 
...
# Filling TH2
#tt.Draw("l0_pt:l0_matched_muon_dxy>>nfl0", "abs(l0_pdgId) == 13 & l0_matched_muon_charge == l0_charge & l0_matched_muon_pt > 3 & abs(l0_eta) < 2.4")
#tt.Draw("l1_pt:l1_matched_muon_dxy>>nfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 3 & abs(l1_eta) < 2.4")
#tt.Draw("l2_pt:l2_matched_muon_dxy>>nfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 3 & abs(l2_eta) < 2.4")
#tt.Draw("l0_pt:l0_matched_muon_dxy>>cfl0", "abs(l0_pdgId) == 13 & l0_matched_muon_charge != l0_charge & l0_matched_muon_pt > 3 & abs(l0_eta) < 2.4")
#tt.Draw("l1_pt:l1_matched_muon_dxy>>cfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 3 & abs(l1_eta) < 2.4")
#tt.Draw("l2_pt:l2_matched_muon_dxy>>cfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 3 & abs(l2_eta) < 2.4")
