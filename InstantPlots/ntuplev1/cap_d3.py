...
c1 = ROOT.TCanvas('c1','c1 cap_d3')
c2 = ROOT.TCanvas('c2','c2 cap_d3')
c3 = ROOT.TCanvas('c3','c3 cap_d3')
c4 = ROOT.TCanvas('c4','c4 cap_d3')
c5 = ROOT.TCanvas('c5','c5 cap_d3')
...
#slimmed mu
tt.Draw("l0_pt >> smul0", "abs(l0_pdgId)==13 & l0_matched_muon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 2.4 & abs(l0_eta) > 1.2 & hnl_2d_disp < 350 & hnl_2d_disp > 120")
...
#ds mu 
tt.Draw("l0_pt >> dsmul0", "abs(l0_pdgId)==13 & l0_matched_dsmuon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 2.4 & abs(l0_eta) > 1.2 & hnl_2d_disp < 350 & hnl_2d_disp > 120")
...
c3.SaveAs(output_dir + 'cap_d3_smu_l012pt.root')
c4.SaveAs(output_dir + 'cap_d3_dsmu_l012pt.root')
c5.SaveAs(output_dir + 'cap_d3.root')
