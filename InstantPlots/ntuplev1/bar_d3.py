...
c1 = ROOT.TCanvas('c1','c1 bar_d3')
c2 = ROOT.TCanvas('c2','c2 bar_d3')
c3 = ROOT.TCanvas('c3','c3 bar_d3')
c4 = ROOT.TCanvas('c4','c4 bar_d3')
c5 = ROOT.TCanvas('c5','c5 bar_d3')
...
#slimmed mu
tt.Draw("l0_pt >> smul0", "abs(l0_pdgId)==13 & l0_matched_muon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
...
c3.SaveAs(output_dir + 'bar_d3_smu_l012pt.root')
c4.SaveAs(output_dir + 'bar_d3_dsmu_l012pt.root')
c5.SaveAs(output_dir + 'bar_d3.root')
