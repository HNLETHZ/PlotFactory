...
c1 = ROOT.TCanvas('c1','c1 bar_d3 sa')
c2 = ROOT.TCanvas('c2','c2 bar_d3 ds')
c3 = ROOT.TCanvas('c3','c3 bar_d3 sa')
c4 = ROOT.TCanvas('c4','c4 bar_d3 ds')
c5 = ROOT.TCanvas('c5','c5 bar_d3 sa / ds')
c6 = ROOT.TCanvas('c6','c6 bar_d3 g')
c7 = ROOT.TCanvas('c7','c7 bar_d3 dg')
c8 = ROOT.TCanvas('c8','c8 bar_d3 g')
c9 = ROOT.TCanvas('c9','c9 bar_d3 dg')
c10= ROOT.TCanvas('c10','c10 bar_d3 g / dg')
##################### 
# create histograms #
#####################
# d in cm           #
...
# slimmed standalone #
###################### 
tt.Draw("l0_pt >> samul0", "abs(l0_pdgId) == 13 & l0_matched_muon_is_sa == 1 & l0_matched_muon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l1_pt >> samunfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_sa == 1 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l2_pt >> samunfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_sa == 1 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l1_pt >> samucfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_sa == 1 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l2_pt >> samucfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_sa == 1 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
######################## 
# displaced standalone #
######################## 
tt.Draw("l0_pt >> dsmul0", "abs(l0_pdgId) == 13 & l0_matched_dsmuon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
...
# slimmed global #
################## 
tt.Draw("l0_pt >> gmul0", "abs(l0_pdgId) == 13 & l0_matched_muon_is_gl == 1 & l0_matched_muon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l1_pt >> gmunfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_gl == 1 & l1_matched_muon_charge == l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l2_pt >> gmunfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_gl == 1 & l2_matched_muon_charge == l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l1_pt >> gmucfl1", "abs(l1_pdgId) == 13 & l1_matched_muon_is_gl == 1 & l1_matched_muon_charge != l1_charge & l1_matched_muon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l2_pt >> gmucfl2", "abs(l2_pdgId) == 13 & l2_matched_muon_is_gl == 1 & l2_matched_muon_charge != l2_charge & l2_matched_muon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
#################### 
# displaced global #
####################
tt.Draw("l0_pt >> dgmul0", "abs(l0_pdgId) == 13 & l0_matched_dgmuon_pt > 0 & l0_pt > 5 & abs(l0_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l1_pt >> dgmunfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge == l1_charge & l1_matched_dgmuon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l2_pt >> dgmunfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge == l2_charge & l2_matched_dgmuon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l1_pt >> dgmucfl1", "abs(l1_pdgId) == 13 & l1_matched_dgmuon_charge != l1_charge & l1_matched_dgmuon_pt > 0  & l1_pt > 5 & abs(l1_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
tt.Draw("l2_pt >> dgmucfl2", "abs(l2_pdgId) == 13 & l2_matched_dgmuon_charge != l2_charge & l2_matched_dgmuon_pt > 0  & l2_pt > 5 & abs(l2_eta) < 0.8 & hnl_2d_disp > 120 & hnl_2d_disp < 350")
#################### 
# Computing histos #
#################### 
...
for cc in [c1,c2,c3,c4,c5,c6,c7,c8,c9,c10]:
    ...
    cc.Update()
###################################################  
c1.SaveAs(output_dir + 'bar_d3_samu_l12.root')
c2.SaveAs(output_dir + 'bar_d3_dsmu_l12.root')
c3.SaveAs(output_dir + 'bar_d3_samu_l012pt.root')
c4.SaveAs(output_dir + 'bar_d3_dsmu_l012pt.root')
c5.SaveAs(output_dir + 'bar_d3_sa.root')
c6.SaveAs(output_dir + 'bar_d3_gmu_l12.root')
c7.SaveAs(output_dir + 'bar_d3_dgmu_l12.root')
c8.SaveAs(output_dir + 'bar_d3_gmu_l012pt.root')
c9.SaveAs(output_dir + 'bar_d3_dgmu_l012pt.root')
c10.SaveAs(output_dir + 'bar_d3_gl.root')
################################################### 
